...
class JournalScreenTests(TestCase):
    ...
    def test_list_shows_irp(self):
        ...
        self.assertContains(resp, 'class="data data--responsive" data-client-sort data-table-key="journal"')
        self.assertContains(resp, 'class="col-id data-sort" aria-sort="none"')
        self.assertContains(resp, 'class="col-date_create data-sort" aria-sort="descending"')
        ...
        self.assertContains(resp, 'aria-label="Настроить таблицу Реестр обращений"')
        ...
        self.assertNotContains(resp, "group-row")
        ...
        self.assertIn("var(--table-row-alt-bg)", css)
        self.assertNotIn("min-width: 1130px !important", css)
        ...
        self.assertNotIn("const mobile = innerWidth <= 900", visual_qa)
        self.assertNotIn(".data--journal thead { display: none; }", css)
